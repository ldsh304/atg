...
<html>
	...
	<body style="background-color: #29508B;width:950px;margin:0 auto">
		...
		<div style="background-color: #FFFFFF;padding-top: 5px;overflow:hidden;">
			<h1 style="padding-left:15px;">发起主题</h1><hr>
		</div>
		<div style="background-color: #FFFFFF;width: 950px;height: 500px;">
			...
			<div style="width: 804px;float: left;padding-left: 23px;">
	            <form action="handreply?type=<%=type%>" method="post" onsubmit="return check()">
					<input type="hidden" value="<%=request.getHeader("Referer")%>" name="lasturl">
	            	<table>
	            		<tr>
	            			<td>主题：</td>
	            			<td><input type="text" name="subject" id="subject" style="width: 600px;"><span style="color: gray;"></span></td>
	            		</tr>
	            		<tr>
	            			<td>内容：</td>
		...
		<script type="text/javascript">
			function check() {
				if(document.getElementById("content").value.trim() == "" || document.getElementById("subject").value.trim()==""){
					return false;
				}
				return true;
			}
